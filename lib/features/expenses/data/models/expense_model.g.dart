...
extension ExpenseModelQueryWhere
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> firebaseIdEqualTo(
      String? firebaseId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'firebaseId',
...
extension ExpenseModelQuerySortBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByFirebaseId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByLastSyncAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQuerySortThenBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByFirebaseId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firebaseId', Sort.asc);
    });
  }
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByLastSyncAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSyncAt', Sort.asc);
    });
  }
...
extension ExpenseModelQueryWhereDistinct
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByFirebaseId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByLastSyncAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQueryProperty
  ...
  QueryBuilder<ExpenseModel, String?, QQueryOperations> firebaseIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'firebaseId');
    });
  }

  QueryBuilder<ExpenseModel, DateTime?, QQueryOperations> lastSyncAtProperty() {
    return QueryBuilder.apply(this, (query) {
